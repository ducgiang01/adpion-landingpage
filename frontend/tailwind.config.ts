  ...
  theme: {
    extend: {
      ...
      keyframes: {
        ...
        pulseGlow: { "0%,100%":{boxShadow:"0 0 20px rgba(59,130,246,0.5)"}, "50%":{boxShadow:"0 0 40px rgba(59,130,246,0.8)"} }
      },
      animation: {
        "fade-in-up":"fadeInUp .6s ease-out",
        "fade-in-down":"fadeInDown .6s ease-out",
        "scale-in":"scaleIn .6s ease-out",
        "float":"float 6s ease-in-out infinite",
        "pulse-glow":"pulseGlow 2s ease-in-out infinite"
      },
      fontFamily: { display:["var(--font-inter)","system-ui","sans-serif"], body:["var(--font-inter)","system-ui","sans-serif"] }
    }
  },
  plugins: [
